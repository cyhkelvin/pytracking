...
from ltr.models.tracking import hcat as hcat_models
from ltr.models.loss import hcat_loss
...
def run(settings):
    ...
    settings.center_jitter_factor = {'test': 3, 'train': 0}
    settings.scale_jitter_factor = {'test': 0.25, 'train': 0}
    ...
    dataset_train = sampler.HCATSampler([lasot_train], [1], samples_per_epoch=1000*settings.batch_size, max_gap=100, processing=data_processing_train)
    ...
    objective = hcat_loss.hcat_loss(settings)
